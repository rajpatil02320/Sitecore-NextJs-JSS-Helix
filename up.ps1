...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.SPJ_jss.localhost/ --auth https://id.SPJ_jss.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.SPJ_jss.localhost/ --auth https://id.SPJ_jss.localhost/ --allow-write true
}
...
if (Test-Path .\src\Project\items\content) {
...
Start-Process https://cm.SPJ_jss.localhost/sitecore/
Start-Process https://www.SPJ_jss.localhost/

Write-Host ""
Write-Host "Use the following command to monitor your Rendering Host:" -ForegroundColor Green
Write-Host "docker-compose logs -f nextjs"
Write-Host ""
